...
class ResidualQAgent(nn.Module):
    def __init__(
        self, base_policy, use_state, obs_shape, prop_shape, action_dim, rl_camera: str, cfg: ResidualQAgentConfig
    ):
        super().__init__()
